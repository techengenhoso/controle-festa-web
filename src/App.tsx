      ...
      <div className="app-container">
        ...
        <div className="layout">
          ...
          <div className="content">
            {section === 'parties' && <Section title="Festas" subtitle="Gerencie eventos" actions={<div className="party-actions"><Button onClick={() => openPartyForm()}>Criar festa</Button><Button variant="secondary" onClick={() => setShowArchived((value) => !value)}>Arquivo</Button></div>}>
